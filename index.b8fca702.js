...
function showMessage(messageType) {
    ...
    if (messageType === "lose") messageLose.classList.remove("hidden");
    else if (messageType === "win") messageWin.classList.remove("hidden");
    else if (messageType === "start") messageStart.classList.remove("hidden");
}
...
document.addEventListener("keydown", (ev)=>{
    if (game.status === "playing") switch(ev.key){
        case "ArrowLeft":
            game.moveLeft();
            break;
        case "ArrowRight":
    ...
    if (game.isGameOver()) showMessage("lose");
    else if (game.status === "win") showMessage("win");
